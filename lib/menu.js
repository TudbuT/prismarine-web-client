  ...
  render () {
    ...
    <div class="login-box">
      ...
      <form>
        ...
        <div class="field-spacev"></div>
        <div class="wrapper">
          <legacy-text-field field-width="100%" field-label="Email" field-id="username" field-value="${this.username}" @input=${e => { this.username = e.target.value }}></legacy-text-field>
          <legacy-text-field field-width="100%" field-label="Password" field-id="password" field-value="${this.password}" @input=${e => { this.password = e.target.value }}></legacy-text-field>
        </div>
